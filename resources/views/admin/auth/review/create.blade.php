        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="{{ route("$route.store") }}" method="POST" class="forms-sample" enctype="multipart/form-data">
                        @csrf
                            ...
                            <div class="col-sm-9">
                                <select name="puzzles_gameplay" class="form-control" id="puzzles_gameplay">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}"
                                        @if($i==old('puzzles_gameplay')) selected @endif>{{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="design_and_theming" class="form-control" id="design_and_theming">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}"
                                        @if($i==old('design_and_theming')) selected @endif>{{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="innovation_tech" class="form-control" id="innovation_tech">
                                    ...
                                    @for ($i = 1; $i <= 10; $i++) <option value="{{ $i }}"
                                        @if($i==old('innovation_tech')) selected @endif>{{ $i }}</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
