                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="top_list" class="form-control" id="top_list">
                                    ...
                                    <option value="{{ $topList->id }}" @if($topList->id==old('top_list')) selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <select name="review" class="form-control" id="review">
                                    ...
                                    <option value="{{ $review->id }}" @if($review->id==old('review')) selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="overview" class="form-control" id="overview"
                                    placeholder="Overview" value="{{ old('overview') }}">
                            </div>
                        </div>
